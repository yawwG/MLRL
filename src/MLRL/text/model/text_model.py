    ...
    def forward(self, ids, attn_mask, token_type):
        ...
        if self.last_n_layers > 1:
            ...
            if self.aggregate_method == "sum":
                ...
                text_mlp1 = embeddings[:,0:2,:,:].sum(axis=1)
                text_mlp2 = word_embeddings - text_mlp1
                text_mlp1 = text_mlp1.permute(0, 2, 1)
                text_mlp2 = text_mlp2.permute(0, 2, 1)
        ...
        # text_mlp1 = self.dropout(text_mlp1)
        # text_mlp2 = self.dropout(text_mlp2)
